...
import { ColorClashManagerService } from './games/color-clash/utils/color-clash-manager.service';
...
import { QuizManagerService } from './games/quantum-quiz/utils/quiz-manager.service';
